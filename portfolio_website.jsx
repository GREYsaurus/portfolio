    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
      ...
      >
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 mt-2">
          IT Professional | Aspiring Software Developer
        </p>
      </motion.header>
      ...
      >
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          I'm an IT professional actively transitioning into a software
          development career. Skilled in C# and Python, I enjoy building
          efficient, scalable applications and am always eager to learn and take
          on new challenges.
        </p>
      </motion.section>
      ...
      >
        <p>
          Connect with me:{" "}
          <a
            href="https://github.com/GREYsaurus"
